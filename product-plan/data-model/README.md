...
This document defines the core entities and their relationships in AGRD.
...
These entity definitions are intentionally high-level. Your implementation should:

1. Add database-specific fields (IDs, timestamps, foreign keys)
2. Define validation rules and constraints
3. Implement business logic for state transitions
4. Add indexes for query performance
5. Consider audit trails for governance

The TypeScript interfaces in `types.ts` provide starting points for your data structures.
