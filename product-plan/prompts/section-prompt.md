...
- **SECTION_NAME** = [e.g., "Strategy Brain" or "Lifecycle & Compounding Engine"]
- **SECTION_ID** = [e.g., "strategy-brain" or "lifecycle-and-compounding-engine"]
- **NN** = [Milestone number: "02" through "06" — sections start at 02 since 01 is Foundation]

---

I need you to implement the **SECTION_NAME** section of my AGRD application.
...
2. **@product-plan/sections/SECTION_ID/README.md** — Feature overview for this section (if available)
